...
<footer class="page-footer font-small stylish-color-dark pt-4">
    ...
    <ul class="list-unstyled list-inline text-center py-2">
        <li class="list-inline-item">
            <a href="#!" style="text-decoration:none;">Mentions légales |</a>
        </li>
        <li class="list-inline-item">
            <a href="#!" style="text-decoration:none;">Protéction des données |</a>
        </li>
        <li class="list-inline-item">
            <a href="#!" style="text-decoration:none;">CGV |</a>
        </li>
        <li class="list-inline-item">
            <a href="#!" style="text-decoration:none;">*Conditions des offres |</a>
        </li>
        <li class="list-inline-item">
            <a href="#!" style="text-decoration:none;">Traitement des données</a>
        </li>
    </ul>
    <!-- Call to action -->
    ...
    <div class="footer-copyright text-center py-3">© 2019 Copyright:
        <a href="#"> DWWM | Session 2018-2019</a>
    </div>
    <!-- Copyright -->
